const Address = require("../../Schema/Delivery/DeliveryAddress");
...
exports.NewAddress = async (req, res) => {
  ...
  console.log("data from deliveryman address", req.body);
  try {
    var processedAddress = await fetchGeocodingData(
      location.latitude,
      location.longitude
    );
...
exports.UpdateMyDetails = async (req, res) => {
  ...
  try {
    ...
    console.log("Total Matched Data : ", result.matchedCount);
